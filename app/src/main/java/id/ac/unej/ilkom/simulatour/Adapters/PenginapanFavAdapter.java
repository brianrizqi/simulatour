...
public class PenginapanFavAdapter extends RecyclerView.Adapter<PenginapanFavAdapter.ViewHolder> {
    private Activity activity;
    private List<PenginapanFav> list;

    public PenginapanFavAdapter(Activity activity, List<PenginapanFav> list) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        final PenginapanFav fav = list.get(i);
